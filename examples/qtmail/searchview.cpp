...
public:
    BodySearchWidget(QWidget* parent = nullptr);
...
public:
    FolderSelectorWidget(QWidget* parent = nullptr);
...
public:
    SearchTermWidget(QWidget* parent = nullptr);
    void reset();
    QMailMessageKey searchKey() const;
...
public:
    SearchTermsComposer(QWidget* parent = nullptr);
    QMailMessageKey searchKey() const;
