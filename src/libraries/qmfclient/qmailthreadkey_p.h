...
#ifndef QMAILTHREADKEY_P_H
#define QMAILTHREADKEY_P_H
...
{
public:
    typedef MailKeyImpl<QMailThreadKey> Impl;

    QMailThreadKeyPrivate() : Impl() {}
    QMailThreadKeyPrivate(QMailThreadKey::Property p, const QVariant &v, QMailKey::Comparator c) : Impl(p, v, c) {}
